...
function swAveraged(sentenceObject, wordsProbability, minSentenceLen){
 ...
 * @param {string[]} documentList List of the documents
 * @param {number} targetWordCount Target summary length (minimum)
 * @param {number} minSentenceLen Minimum length of a sentence to be weighted in the SumBasic process
 */
function sumBasic(documentList, targetWordCount=10, minSentenceLen=3){
    ...
    while (cummulativeWordLen<targetWordCount){
        ...
        sentenceObject = swAveraged(sentenceObject, wordsProbability, minSentenceLen);
        //sort the weights
